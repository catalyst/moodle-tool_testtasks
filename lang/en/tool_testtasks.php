...
$string['stored_progress_scheduled_task_iterations'] = 'Stored progress scheduled task iterations';
$string['stored_progress_scheduled_task_manual'] = 'Stored progress scheduled task manual';
